...
class App {
    ...
    createMedias(
        ...
        const defaultItems = [
            ...
            {
                image: `/Carousel/Carousel6.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel7.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel8.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel9.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel10.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel11.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel12.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel13.png`,
                text: "",
            },
            {
                image: `/Carousel/Carousel14.png`,
                text: "",
            },
        ];
...
export default function CircularGallery({
    ...
    return (
        <div
            className="w-full h-100 overflow-hidden cursor-grab active:cursor-grabbing"
            ref={containerRef}
        />
    );
}
